// inclui nos parametros de where req.user.id para que as requisições só sejam feitas diante de usuários autenticados
module.exports = app => {
    ...
    app.route("/tasks")
         ...
         *      { "Authoriztion": JWT xyz.abc.123.hgf }
         * @apiSucsess {Object[]} tasks Lista de tarefas
